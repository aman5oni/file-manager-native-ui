			...
			>
				<View style={styles.header}>
					...
					<View style={styles.top}>
						<Image source={require("../images/Profile1.jpeg")} style={styles.av} />
			...
			<ScrollView style={{ marginTop: -60 }}>
				<Animated.View style={[pan.getLayout(), styles.card]}>
					<View style={styles.col2}>
						...
						<View style={styles.col2}>
							<Image
								source={require("../images/Profile1.jpeg")}
				...
				<Animated.View style={[list.getLayout(), styles.list]}>
					<Storages image={require("../images/Cloud.png")} title={"One Drive"} />
					<Storages
						image={require("../images/Drive.png")}
						title={"Google Drive"}
					/>
					<Storages image={require("../images/DropBox.png")} title={"Dropbox"} />
				</Animated.View>
			</ScrollView>
		</View>
	);
